    ...
    <div className="flex h-full min-h-0 bg-[#0a0a14] font-sans overflow-hidden">
      ...
      >
        <div className="flex items-center justify-between h-20 px-6 border-b border-white/5">
          ...
          <button 
            onClick={() => setSidebarOpen(false)}
            className="p-1 rounded-lg text-white/40 hover:bg-surface/5 hover:text-white lg:hidden"
          >
            <X className="w-5 h-5" />
          </button>
        </div>
              ...
              <Link
                ...
                className={`flex items-center justify-between px-4 py-3.5 rounded-xl transition-all duration-200 group ${
                  isActive 
                    ...
                    : 'text-white/60 hover:bg-surface/5 hover:text-white border border-transparent'
                }`}
              >
        ...
        <div className="p-4 border-t border-white/5 space-y-2">
          <Link
            to="/products"
            className="flex items-center justify-center gap-2 w-full px-4 py-3 rounded-xl bg-surface/5 hover:bg-surface/10 border border-white/10 font-medium text-sm text-white/70 hover:text-white transition-all"
          >
        ...
        <header className="flex items-center justify-between h-20 px-6 lg:px-8 bg-[#12081a]/80 backdrop-blur-md border-b border-[#d4af37]/10 flex-shrink-0">
          <div className="flex items-center gap-4">
            <button
              ...
              className="p-2 rounded-xl text-white/60 hover:bg-surface/5 lg:hidden"
            >
          ...
          <div className="flex items-center gap-4">
            ...
            <div className="w-px h-8 bg-surface/10 hidden sm:block" />

            <div className="flex items-center gap-2 px-3 py-1.5 rounded-xl bg-surface/5 border border-white/10">
